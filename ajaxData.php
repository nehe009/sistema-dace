...
if(isset($_POST["obtenerPais"]) && !empty($_POST["obtenerPais"])){    
    #consulta de paises.
...
if(isset($_POST["obtenerEstado"]) && !empty($_POST["obtenerEstado"])){    
    #consulta por id
...
if(isset($_POST["obtenerCiudad"]) && !empty($_POST["obtenerCiudad"])){    
    #consulta por id
...
if(isset($_POST["obtenerMunicipio"]) && !empty($_POST["obtenerMunicipio"])){    
    #consulta por id
...
if(isset($_POST["obtenerParroquia"]) && !empty($_POST["obtenerParroquia"])){    
    #consulta por id
